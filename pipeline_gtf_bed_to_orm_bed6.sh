...
cat $gtf | awk '/transcript\t/{print $1,$4,$5,$10,"fiber","NA"} !/transcript\t/{if($6!="."){print $1,($4+$5)/2,($4+$5)/2,$12,"nucleotide",$6}}' OFS='\t' | sed 's/chr23/chrX/g' | sed 's/chr24/chrY/g' | sed 's/\"TRP//g' | sed 's/[";]//g'  > tmp_${out}.bed
